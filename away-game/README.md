...
|---|---|---|---|
| 1 | Task modeling (revised after feedback) | Done, v2 | [`docs/01-task-model.md`](docs/01-task-model.md) |
...
| 3 | Personas | Proto-personas, need validation | [`docs/03-personas.md`](docs/03-personas.md) |
...
The prototype works offline after the first load (service worker), because the biggest lesson from bootlegging was that wifi, roaming, and battery fail exactly when an athlete is furthest from home.
